...
alter table cart_products
    add constraint fk_products_cart foreign key (cart_id) references cart;
alter table cart_products
    add constraint fk_cart_products foreign key (products_id) references product;


insert into customer (customer_name, country, postal_code, city, address, email, phone) values ('Dianna Brickner', 'Croatia', '32235', 'Bapska', '7595 Golf View Parkway', 'dbrickner0@vk.com', '(414) 3416616'),
                                                                                               ('Briggs Hargreves', 'Russia', '356003', 'Novoaleksandrovsk', '00 Maple Circle', 'bhargreves1@webnode.com', '(794) 2592094'),
                                                                                               ('Sallyann Yeomans', 'Indonesia', '67456', 'Pancalan', '93 Logan Crossing', 'syeomans2@webnode.com', '(117) 3068369'),
                                                                                               ('Kristal Dallmann', 'United Kingdom', 'CH48', 'Wirral', '30733 Maple Wood Alley', 'kdallmann3@hostgator.com', '(500) 1293366'),
                                                                                               ('Margalo Dunstan', 'China', '82334', 'Yanmen', '52 Fuller Point', 'mdunstan4@surveymonkey.com', '(850) 7128626'),
                                                                                               ('Perceval Naul', 'Philippines', '7505', 'Bakung', '7 Summer Ridge Place', 'pnaul5@feedburner.com', '(553) 1289659'),
                                                                                               ('Philomena Boyett', 'Brazil', '13990-000', 'Espírito Santo do Pinhal', '89442 Coolidge Street', 'pboyett6@alibaba.com', '(611) 8242224'),
                                                                                               ...
                                                                                               ('Brion Hitschke', 'Colombia', '413067', 'Hobo', '16 Eagle Crest Plaza', 'bhitschke9@oakley.com', '(366) 1843437');
...
insert into cart_products (products_id, cart_id) values (5, 1);
insert into cart_products (products_id, cart_id) values (10, 1);
insert into cart_products (products_id, cart_id) values (11, 4);
insert into cart_products (products_id, cart_id) values (3, 4);
insert into cart_products (products_id, cart_id) values (9, 3);
insert into cart_products (products_id, cart_id) values (1, 2);
insert into cart_products (products_id, cart_id) values (4, 2);